...
<div class="col-lg-12 margin-tb">
    ...
    <div class="pull-right" style="text-align: right;">
        <a class="btn btn-success" href="{{ route('create-barangkeluar') }}"> Create</a>
...
<table class="table align-middle mb-0 bg-white" id="dataTable">
  ...
  @foreach ($barangkeluars as $barangkeluar)
    <tr>
      ...
      <td>
          <a href="{{ url('edit-barangkeluars',$barangkeluar->id) }}">Edit</a> 
          |  
          <a href="{{ url('delete-barangkeluars',$barangkeluar->id) }}">Hapus</a>
      </td>
    </tr>
@endforeach
  </tbody>
