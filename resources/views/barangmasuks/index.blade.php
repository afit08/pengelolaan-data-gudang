...
<div class="col-lg-12 margin-tb">
    ...
    <div class="pull-right" style="text-align: right;">
        <a class="btn btn-success" href="{{ route('create-barangmasuk') }}"> Create</a>
...
<table class="table align-middle mb-0 bg-white" id="dataTable">
  ...
  @foreach ($barangmasuks as $barangmasuk)
    <tr>
      ...
      <td>
          <a href="{{ url('edit-barangmasuks',$barangmasuk->id) }}">Edit</a> 
          |  
          <a href="{{ url('delete-barangmasuks',$barangmasuk->id) }}">Hapus</a>
      </td>
    </tr>
@endforeach
  </tbody>
